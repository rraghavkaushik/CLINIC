...
csv_path = os.path.join(os.getcwd(), "privacy-dataset.csv")
...
base_dir = os.path.join(os.getcwd(), f"{task_name}_respon_{model_name}")
...
for lang in languages:
    ...
    lang_questions = questions_df[lang][:200]
